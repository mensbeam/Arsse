...
class TestV1 extends \JKingWeb\Arsse\Test\AbstractTest {
    ...
    public static function provideEntryQueries(): iterable {
        ...
        $o = ["added_date"]; // the default sort order
        return [
            ...
            ["/entries?category_id=0",                             $c,                                                                    $o,                        self::ENTRIES,                   false, HTTP::respJson(['total' => sizeof($entriesOut), 'entries' => $entriesOut])],
            ["/entries?after_entry_id=0",                          $c,                                                                    $o,                        self::ENTRIES,                   false, HTTP::respJson(['total' => sizeof($entriesOut), 'entries' => $entriesOut])],
            ["/entries?before_entry_id=0",                         $c,                                                                    $o,                        self::ENTRIES,                   false, HTTP::respJson(['total' => sizeof($entriesOut), 'entries' => $entriesOut])],
            ["/entries?limit=-1",                                  $c,                                                                    $o,                        self::ENTRIES,                   false, HTTP::respJson(['total' => sizeof($entriesOut), 'entries' => $entriesOut])],
            ["/entries?offset=-1",                                 $c,                                                                    $o,                        self::ENTRIES,                   false, HTTP::respJson(['total' => sizeof($entriesOut), 'entries' => $entriesOut])],
            ...
            ["/entries?bogus=value",                               $c,                                                                    $o,                        self::ENTRIES,                   false, HTTP::respJson(['total' => sizeof($entriesOut), 'entries' => $entriesOut])],
            ...
            ["/entries?order=created_at",                          $c,                                                                    $o,                        self::ENTRIES,                   false, HTTP::respJson(['total' => sizeof($entriesOut), 'entries' => $entriesOut])],
            ["/entries?order=published_at",                        $c,                                                                    ["published_date"],        self::ENTRIES,                   false, HTTP::respJson(['total' => sizeof($entriesOut), 'entries' => $entriesOut])],
            ["/entries?order=changed_at",                          $c,                                                                    ["modified_date"],         self::ENTRIES,                   false, HTTP::respJson(['total' => sizeof($entriesOut), 'entries' => $entriesOut])],
            ...
            ["/entries?direction=desc",                            $c,                                                                    ["added_date desc"],       self::ENTRIES,                   false, HTTP::respJson(['total' => sizeof($entriesOut), 'entries' => $entriesOut])],
            ["/entries?order=id&direction=desc",                   $c,                                                                    ["id desc"],               self::ENTRIES,                   false, HTTP::respJson(['total' => sizeof($entriesOut), 'entries' => $entriesOut])],
            ["/entries?order=published_at&direction=desc",         $c,                                                                    ["published_date desc"],   self::ENTRIES,                   false, HTTP::respJson(['total' => sizeof($entriesOut), 'entries' => $entriesOut])],
